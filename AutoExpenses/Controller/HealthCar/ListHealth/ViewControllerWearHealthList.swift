...
class ViewControllerWearHealthList: ViewControllerThemeColor {
    ...
    private var arrayArrays: [[ModelTimeAndMileageWear]]
...
extension ViewControllerWearHealthList: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        switch section {
        case 0:
            headerView.setup(text: "К срочной проверке или замене", colorPoint: UIColor.init(rgb: 0xFF4444), colorLine: .white)
        case 1:
            headerView.setup(text: "В нормальном состоянии", colorPoint: UIColor.init(rgb: 0xFFB815), colorLine: UIColor.init(rgb: 0xF8F8F8))
        default:
            headerView.setup(text: "Не требует вмешательств", colorPoint: UIColor.init(rgb: 0x1CD194), colorLine: UIColor.init(rgb: 0xF8F8F8))
        }
